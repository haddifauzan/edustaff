...
<div class="layout-page">
          ...
          <li class="nav-item lh-1 me-3 position-relative">
            ...
            <ul class="dropdown-menu dropdown-menu-end p-1" aria-labelledby="notificationDropdown" style="min-width: 330px; max-width: 100%; position: absolute; right: 0; left: auto;">
                ...
                <div class="dropdown-footer d-flex align-items-center justify-content-center">
                  <a href="{{ route('notifikasi.pegawai', auth()->user()->id_user) }}" class="fw-bold my-2">View all notifications</a>
                </div>
            </ul>
          </li>        
    ...
    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasProfile" aria-labelledby="offcanvasProfileLabel" style="width: 500px;">
      ...
      <div class="offcanvas-body">
          <!-- Profile Form -->
          <form id="profileForm" action="{{route('profile.update.pegawai')}}" method="POST" enctype="multipart/form-data">
              @csrf
              <div class="mb-3">
            ...
            <div class="mb-3" style="display: none;" id="changePasswordForm">
              ...
              <div class="d-flex justify-content-between mt-3">
                  ...
                  <a href="{{ route('pegawai.profile') }}" class="btn btn-success" id="detailProfileBtn">Detail Profil</a>
      ...
      document.addEventListener('DOMContentLoaded', function() {
          ...
          editProfileBtn.addEventListener('click', function() {
              if (!isEditing) {
                  ...
                  detailProfileBtn.style.display = 'none';
          ...
          cancelEditBtn.addEventListener('click', function() {
              if (isEditing) {
                  ...
                  detailProfileBtn.style.display = 'block';
