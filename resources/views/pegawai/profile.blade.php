        ...
        <div class="col-md-10 mx-auto">
            <div class="card shadow-sm">
                <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
                    ...
                    <div>
                        <a href="{{ route('pegawai.dashboard') }}" class="btn btn-danger"><i class="bx bx-arrow-back me-2"></i> Kembali</a>
                        <a href="{{ route('pegawai.perubahan') }}" class="btn btn-warning"><i class="bx bx-edit me-2"></i> Ajukan Perubahan Data</a>
                    </div>
                </div>
                ...
                <div class="card-body mt-3">
                                ...
                                <table class="table table-borderless">
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($pegawai->riwayatJabatan->last())
                                                    {{ \Carbon\Carbon::parse($pegawai->riwayatJabatan->last()->tgl_mulai)->format('d/m/Y') }}
                                                @else
                                                    -
                                                @endif
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($pegawai->riwayatJabatan->last())
                                                    {{ $pegawai->riwayatJabatan->last()->tgl_selesai ? \Carbon\Carbon::parse($pegawai->riwayatJabatan->last()->tgl_selesai)->format('d/m/Y') : '-' }}
                                                @else
                                                    -
                                                @endif
                                            </td>
                    ...
                    <hr>
                    <h4 class="my-4 text-center">Dokumen Pegawai</h4>
                    <div class="row">
