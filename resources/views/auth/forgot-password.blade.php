            ...
            <div class="card transparent-card" style="max-width: 450px; min-width: 100%;">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('password.email') }}">
                        ...
                        <button type="submit" class="btn btn-primary w-100" id="btn-send-password-link"><i class="bx bx-mail-send me-2"></i> {{ __('Send Password Reset Link') }}</button>
                        <span id="loading-icon" style="display: none;"><i class="bx bx-loader bx-spin me-2"></i> {{ __('Sending...') }}</span>
                        <script>
                            document.getElementById('btn-send-password-link').addEventListener('click', function() {
                                document.getElementById('btn-send-password-link').style.display = 'none';
