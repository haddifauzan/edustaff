  ...
  <body>
            ...
            <div class="card transparent-card" style="max-width: 450px; min-width: 100%;">
              <div class="card-body">
                <div class="app-brand d-flex justify-content-center align-items-center ">
                  <img src="{{ asset('/assets/img/logo/smkn1cmi_logo.png') }}" alt="logo" class="app-brand-logo demo me-2" width="50px">
                  <span class="app-brand-text">
                    <h2 class="demo text-body fw-bolder align-middle my-auto">EduStaff</h2>
                  </span>
                </div>
                <h4 class="mb-2 mt-3 text-center">SMK Negeri 1 Cimahi</h4>
                <p class="mb-4">Silahkan masuk dengan akun anda yang sudah terdaftar.</p>
                ...
                <form id="formAuthentication" class="mb-3" action="{{ route('login.submit') }}" method="POST">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email" placeholder="email@example.com" autofocus value="{{ old('email') }}" required/>
                    @error('email')
    ...
    <script>
      document.addEventListener('DOMContentLoaded', function() {
          @if (session('status') == 'login_failed')
              ...
              Toast.fire({
                  icon: 'error',
                  title: "{{ __('Login gagal, silahkan cek kembali email dan password Anda.') }}",
                  customClass: {
                      container: 'custom-toast-container' // Tambahkan kelas kustom jika diperlukan
                  }
              });
          @elseif (session('status') == 'not_verified')
              const Toast = Swal.mixin({
                  background: '#f8d7da',
                  toast: true,
                  position: 'top-end',
              ...
              Toast.fire({
                  icon: 'error',
                  title: "{{ __('Akun Anda belum diverifikasi, silahkan cek kembali email Anda.') }}",
                  customClass: {
                      container: 'custom-toast-container' // Tambahkan kelas kustom jika diperlukan
                  }
              });
