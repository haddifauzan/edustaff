...
<div>
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('operator.pegawai.update', $pegawai->id_pegawai) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT') 
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-6">
                        <label for="password">Password Baru<small class="text-danger">*Minimal 6 karakter</small></label>
                        <div class="form-group input-group input-group-merge">
                            <input type="password" name="password" class="form-control @error('password') is-invalid @enderror" minlength="6" id="password" value="{{ old('password') }}" />
                            @error('password')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group input-group input-group-merge">
                            <input type="password" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" minlength="6" id="password_confirmation" value="{{ old('password_confirmation') }}" />
